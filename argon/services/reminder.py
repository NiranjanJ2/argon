...
class ReminderService:
    ...
    def build_prompt(self, occasion: Occasion) -> str:
        ...
        return (
            ...
            "The app renders **bold**, bullets, `1.` steps, `## headings`, `---` "
            "rules, and `- [ ] item` as a tappable checkbox. Use a checklist when "
            "he is meant to work through the lines, a numbered list for steps in "
            "order, bold for the one word carrying the message. Do not format a "
            "message that is one thought — a wall of bullets fails the same way "
            "a wall of text does.\n\n"
